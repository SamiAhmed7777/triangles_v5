...
// OpenSSL < 1.1.0 requires manual locking callbacks for thread safety.
// OpenSSL >= 1.1.0 handles threading internally; these are no-ops.
...
public:
    ...
    {
#if OPENSSL_VERSION_NUMBER < 0x10100000L
        // Init OpenSSL library multithreading support (pre-1.1.0 only)
...
// Format the subversion field according to BIP 14 spec (https://en.triangles.it/wiki/BIP_0014)
