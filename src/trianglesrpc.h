...
#ifndef _TRIANGLESRPC_H_
#define _TRIANGLESRPC_H_ 1
...
enum RPCErrorCode
{
    ...
    // P2P client errors
    RPC_CLIENT_NOT_CONNECTED        = -9,  // Triangles is not connected
...
/**
 * Triangles RPC command dispatcher.
 */
class CRPCTable
{
private:
